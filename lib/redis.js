...
// The Vercel Upstash integration provisions these as KV_REST_API_*; a direct Upstash
// setup uses UPSTASH_REDIS_REST_*. Accept either. (KV_URL / REDIS_URL are for the native
// Redis protocol, which this REST client does not use.)
